...
|---|---|---:|---:|---:|---|
| R-001 | Printed cam and follower errors prevent one-minute indication. | 4 | 5 | 20 | Rev-A daylight scale is 0.13 mm/min; print runout coupon first and report physical results without claiming the target prematurely. |
| R-002 | Backlash causes different answers depending on setting direction. | 4 | 4 | 16 | Use spring-preloaded roller/linear rail; clockwise is prescribed; the procedure records bidirectional hysteresis separately. |
...
| R-010 | Large cams exceed printer build volume or warp after assembly. | 2 | 4 | 8 | Rev-A one-piece bounding boxes are about 135 mm square; confirm actual printer. Segment only with datum joints and a new coupon/revision. |
...
| R-014 | Slicer seam or elephant foot creates a local false reading. | 3 | 3 | 9 | Coupon-select bore/compensation, place seam at the recorded Jan 1 ray, deburr with a rigid axial block, and retain raw measurements. |
